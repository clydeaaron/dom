...
import { ViewAllSubject } from '../../functions';
                                    ...
                                    <div className='flex py-1 gap-5' key={index}>
                                        ...
                                        <div className='bg-slightwhite text-lightgray px-2 py-2 text-[12px] sm:text-[12px] md:text-[14px] lg:text-[14px] justify-center items-center whitespace-nowrap italic'>
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => data['Subject'] = e.target.value} // Assuming you have a function like handleSubjectChange to update the selected value
                                            >
                                        ...
                                        >
                                            <option defaultValue="" disabled>-- Select Subject Type --</option>
                                        ...
                                        <input
                                            type="text"
                                            name="time[]"
                                            onChange={(e) => data['Time'] = e.target.value}
